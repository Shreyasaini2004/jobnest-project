...
const EventsBulletin = () => {
  ...
  <div className="flex flex-col items-center justify-center gap-3 mb-4">
    <div className="p-3 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full shadow-md">
      <Calendar className="h-8 w-8 text-white" />
    </div>
    <h2 className="text-4xl font-bold leading-snug bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
      Upcoming Events
    </h2>
  </div>
